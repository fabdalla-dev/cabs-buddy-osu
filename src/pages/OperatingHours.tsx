...
const weekdaySchedules: RouteSchedule[] = [
  ...
  { route: 'NS', fullName: 'North-South', firstBus: '6:45 AM', lastBus: '11:45 PM', color: 'bg-purple-500' },
  { route: 'WC', fullName: 'West Campus', firstBus: '7:15 AM', lastBus: '11:00 PM', color: 'bg-orange-500' },
];
...
const weekendSchedules: RouteSchedule[] = [
  ...
  { route: 'NS', fullName: 'North-South', firstBus: '8:30 AM', lastBus: '9:30 PM', color: 'bg-purple-500' },
  { route: 'WC', fullName: 'West Campus', firstBus: 'Not Operating', lastBus: 'Not Operating', color: 'bg-orange-500' },
];
